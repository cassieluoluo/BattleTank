...
namespace ChobiAssets.PTM
{
	...
	public class Barrel_Base_CSEditor : Editor
	{
		...
		void Create ()
		{
			...
			//
			Recoil_Brake_CS recoilScript = parentTransform.GetComponent <Recoil_Brake_CS> ();
			if (recoilScript) {
				recoilScript.Barrel_Type = Barrel_TypeProp.intValue;
			}
			Bullet_Generator_CS generatorScript = parentTransform.GetComponent <Bullet_Generator_CS> ();
			if (generatorScript) {

...
namespace ChobiAssets.PTM
{
	...
	public class Drive_Control_CSEditor : Editor
	{
		...
		SerializedProperty Lost_Brake_RateProp;
		...
		void OnEnable ()
		{
			...
			Lost_Brake_RateProp = serializedObject.FindProperty ("Lost_Brake_Rate");
		...
		public override void OnInspectorGUI ()
		{
			...
			if (EditorApplication.isPlaying == false) {
				...
				if (Acceleration_FlagProp.boolValue) {
					...
					EditorGUILayout.Slider (Lost_Brake_RateProp, 0.0f, 1.0f, "Lost Brake Rate");

...
namespace ChobiAssets.PTM
{
	...
	public class Look_At_Point_CSEditor : Editor
	{
		...
		SerializedProperty Demo_CamProp;
		...
		void  OnEnable ()
		{
			...
			Demo_CamProp = serializedObject.FindProperty ("Demo_Cam");
		}
		...
		public override void OnInspectorGUI ()
		{
			...
			EditorGUILayout.Space ();
			Demo_CamProp.boolValue = EditorGUILayout.Toggle ("Auto Camera for Demo", Demo_CamProp.boolValue);
			EditorGUILayout.Space ();
			EditorGUILayout.Space ();
